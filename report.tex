...
Stop Loss & 1.5$\times$ ATR (EOD exit if not hit) \\
...
\midrule
Jan 1 & HOLD & DOWN & 77.6\% & Uptrend \\
Jan 2 & HOLD & DOWN & 77.6\% & Uptrend \\
...
\vspace{1pt}
\textit{All HOLD: ML predicts DOWN but regime is bullish. Capital preservation.}
\end{tcolorbox}
